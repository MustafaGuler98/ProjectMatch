...
- [5. CORE LOGIC & FEATURES](#5-core-logic--features)
- [6. DEVELOPMENT WORKFLOW](#6-development-workflow)
- [7. DEPLOYMENT & DELIVERY](#7-deployment--delivery)
...
A custom `seed.ts` script is included to automate the initial data population. It reads the provided JSON files and uses Prisma Client to insert the records into the database, ensuring a consistent and repeatable setup.
